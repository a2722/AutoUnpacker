...
from .share import invoke_download  # noqa: F401
...
from . import db, manifest, watch, share  # noqa: F401
# 兼容旧属性名（如 volume_pair 的 getattr(bt, "baidu_manifest")）：同一模块对象。
baidu_db, baidu_manifest, baidu_watch, baidu_share = db, manifest, watch, share  # noqa: F401
